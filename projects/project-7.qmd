...
**Languages & Stack:**
TypeScript, JavaScript, SQL, HTML, CSS, Next.js (App Router), React, Tailwind CSS

**Backend & Database:**
Supabase (PostgreSQL), Row Level Security, Server Actions

**Third-Party Services:**
Clerk (Authentication), Stripe (Payments), Supabase Storage, Lock Vendor API

**Development Tools:**
Claude Code, ChatGPT, GitHub Codespaces, Git
